...
class TestStateInstantiation(unittest.TestCase):
    ...
    def test_id_is_public_str(self):
        """Test if id attribute of State is a public string."""
        self.assertEqual(str, type(State().id))

    def test_created_at_is_public_datetime(self):
        """Test if created_at attribute of State is a public datetime."""
        self.assertEqual(datetime, type(State().created_at))

    def test_updated_at_is_public_datetime(self):
        """Test if updated_at attribute of State is a public datetime."""
        self.assertEqual(datetime, type(State().updated_at))

    def test_name_is_public_class_attribute(self):
        """Test if name attribute of State is a public class attribute."""
        st = State()
    ...
    def test_two_states_different_created_at(self):
        """Test if two instances of State have different created_at times."""
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_two_states_different_updated_at(self):
        """Test if two instances of State have different updated_at times."""
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_str_representation(self):
        """Test if __str__ method of State provides correct string representation."""
        dt = datetime.today()
        dt_repr = repr(dt)
        st = State()
        st.id = "123456"
    ...
    def test_args_unused(self):
        """Test if passing None as argument to State instance does not affect __dict__."""
        st = State(None)
        self.assertNotIn(None, st.__dict__.values())

    def test_instantiation_with_kwargs(self):
        """Test instantiation of State class with keyword arguments."""
        dt = datetime.today()
        dt_iso = dt.isoformat()
    ...
    def test_instantiation_with_None_kwargs(self):
        """Test instantiation of State class with None keyword arguments."""
...
class TestStateSave(unittest.TestCase):
    ...
    def test_two_saves(self):
        """Test saving State instance twice."""
        st = State()
        sleep(0.05)
        first_updated_at = st.updated_at
        st.save()
    ...
    def test_save_with_arg(self):
        """Test saving State instance with argument."""
        st = State()
        with self.assertRaises(TypeError):
            st.save(None)
...
class TestStateToDict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        """Test the output of to_dict method of State."""
        dt = datetime.today()
        st = State()
        st.id = "123456"
        st.created_at = st.updated_at = dt
    ...
    def test_contrast_to_dict_dunder_dict(self):
        """Test that to_dict method of State returns a different dictionary from the __dict__ attribute."""
        st = State()
        self.assertNotEqual(st.to_dict(), st.__dict__)

    def test_to_dict_with_arg(self):
        """Test that passing an argument to to_dict method of State raises a TypeError."""
        st = State()
        with self.assertRaises(TypeError):
            st.to_dict(None)
